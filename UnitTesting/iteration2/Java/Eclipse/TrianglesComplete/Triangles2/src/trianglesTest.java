...
// @CsvSource({"1,1,1", "1,2,2", "3,4,5", "Double.MAX_VALUE,Double.MAX_VALUE,Double.MAX_VALUE"})
	...
	@ParameterizedTest
	// @ValueSource(doubles =
	// {1,1,1,1,1,2,3,4,5,Double.MAX_VALUE,Double.MAX_VALUE,Double.MAX_VALUE})
	...
	private static Stream<Arguments> validSides() {
		return Stream.of(Arguments.of((new double[] { 1, 1, 1 }), true, "valid"),
				...
				Arguments.of((new double[] { Double.MAX_VALUE, Double.MAX_VALUE / 2 + 1, Double.MAX_VALUE / 2 + 1 }),
						false, "not valid"));
	}
